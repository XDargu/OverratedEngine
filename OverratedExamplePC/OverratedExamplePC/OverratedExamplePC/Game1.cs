...
using OverratedExamplePC.Niveles;

namespace OverratedExamplePC
{
    /// <summary>
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        OverratedEngine.Base.OverratedEngine engine;
        ...
        public Game1()
        {
            ...
            engine = new OverratedEngine.Base.OverratedEngine(this);
        }
        ...
        protected override void Initialize()
        {
            ...
            engine.ChangeLevel(new NivelMenuEjemplo(this, engine));
            base.Initialize();
        }
