...
namespace OverratedEngine.GUI
{
    ...
    public abstract class Control : IControl
    {
        ...
        virtual public void Update(GameTime gameTime, KeyboardState keyboardState, KeyboardState keyboardStateOld, MouseState mouseState, MouseState mouseStateOld)
        {
